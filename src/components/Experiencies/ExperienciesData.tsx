...
const experiences: TextBoxProps[] = [
	{
		title: "Ingénieur en développement - Prescom",
		date: "Novembre 2025 - Aujourd'hui",
		description: (
			<ul>
				<li>Développement fullstack d'une application web dans un système de communication intégrés pour salles de contrôle et de commandement</li>
			</ul>
		),
